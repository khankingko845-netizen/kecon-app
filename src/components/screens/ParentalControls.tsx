        ...
        <div className="bg-white rounded-2xl p-4 mb-4 shadow-sm flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-[11px] text-txt-secondary">Giới hạn thời gian & nội dung cho bé</p>
            </div>
          </div>
          <button
            onClick={() => setEnabled(!enabled)}
            className={`w-12 h-7 rounded-full transition-colors ${enabled ? "bg-accent" : "bg-gray-200"}`}
          >
            <div className={`w-5 h-5 bg-white rounded-full shadow-sm transform transition-transform mx-1 ${enabled ? "translate-x-5" : "translate-x-0"}`} />
          </button>
        </div>
          ...
          <>
            ...
            <div className="bg-white rounded-2xl p-4 mb-4 shadow-sm">
              <div className="flex items-center gap-2 mb-3">
                <Lock size={16} className="text-txt-secondary" />
              ...
              <input
                ...
                className="w-full px-4 py-3 rounded-xl bg-gray-50 text-center text-[18px] tracking-[0.5em] font-bold"
              />
            </div>
            ...
            <div className="bg-white rounded-2xl p-4 mb-4 shadow-sm">
              <div className="flex items-center gap-2 mb-3">
                <Clock size={16} className="text-txt-secondary" />
              ...
              {dailyLimit > 0 && (
                <div className="mt-3">
                  ...
                  />
                  <p className="text-[11px] text-center text-txt-secondary mt-1">
            ...
            <div className="bg-white rounded-2xl p-4 mb-4 shadow-sm">
              <div className="flex items-center gap-2 mb-3">
                <Moon size={16} className="text-txt-secondary" />
                <p className="text-[13px] font-bold">Giờ ngủ (không cho nghe)</p>
              </div>
              <div className="grid grid-cols-2 gap-3">
                <div>
                  <label className="text-[11px] text-txt-secondary mb-1 block">Bắt đầu</label>
                  <input
                    type="time"
                    value={bedtimeStart}
                    onChange={(e) => setBedtimeStart(e.target.value)}
                    className="w-full px-3 py-2.5 rounded-xl bg-gray-50 text-[13px] font-bold"
                  />
                </div>
                <div>
                  <label className="text-[11px] text-txt-secondary mb-1 block">Kết thúc</label>
                  <input
                    type="time"
                    value={bedtimeEnd}
              ...
              <div className="grid grid-cols-5 gap-2">
                {[3, 5, 7, 10, 99].map((age) => (
                  <button
                    ...
                    className={`py-2.5 rounded-xl text-[12px] font-bold transition-all ${
                      maxAge === age ? "bg-accent text-white" : "bg-gray-50 text-txt-secondary"
                    }`}
                  >
