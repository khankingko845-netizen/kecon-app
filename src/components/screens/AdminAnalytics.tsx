  ...
  return (
    <div className="min-h-screen bg-surface pb-10">
      ...
      {loading ? (
        ...
        <div className="px-5 pt-4 text-center text-[13px] text-txt-secondary">
          Chưa có dữ liệu
        </div>
      ) : (
        <div className="px-5 pt-2">
          ...
          <div className="grid grid-cols-2 gap-2.5 mb-6">
            <div className="bg-white rounded-2xl p-3.5 shadow-[0_1px_3px_rgba(0,0,0,0.03)]">
              ...
              <div className="text-[11px] text-txt-secondary font-medium">
                Tỷ lệ hoàn thành TB
              </div>
            </div>
            <div className="bg-white rounded-2xl p-3.5 shadow-[0_1px_3px_rgba(0,0,0,0.03)]">
          ...
          <div className="bg-white rounded-2xl p-4 mb-6 shadow-[0_1px_3px_rgba(0,0,0,0.03)] space-y-3">
                ...
                <div key={s.id}>
                  <div className="flex justify-between items-center text-[12px] mb-1">
                    <span className="font-semibold truncate flex-1 min-w-0">
                      <span className="text-txt-secondary mr-1.5">{i + 1}.</span>
                      {s.title}
                    </span>
                    <span className="text-txt-secondary flex items-center gap-2 ml-2 shrink-0">
          ...
          <div className="bg-white rounded-2xl p-4 shadow-[0_1px_3px_rgba(0,0,0,0.03)] space-y-2.5">
              ...
              data.categoryPlays.map((c) => (
                <div key={c.category}>
                  <div className="flex justify-between text-[12px] font-semibold mb-1">
                    ...
                    <span className="text-txt-secondary">{c.plays}</span>
                  </div>
                  <div className="h-2 rounded-full bg-gray-100 overflow-hidden">
                    <div
